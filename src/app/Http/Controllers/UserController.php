...
use DACore\BaseUser\Models\User;
use Carbon\Carbon;
use DACore\MCore\Libraries\Helper as MCHelper;
...
//                $query->where('status',$type);
        ...
        $subtitle = '用户列表';
        return view('dacore.baseadmin::user.list',compact('data','subtitle'));
    }
    ...
    public function add(Request $request)
    {
        ...
        $subtitle = '添加用户';
        return view('dacore.baseadmin::user.add',compact('subtitle'));
    }
    ...
    public function edit(Request $request ,$id ,User $user)
    {
        ...
        $subtitle = '编辑用户';
        return view('dacore.baseadmin::user.edit',compact('data','subtitle'));
    }
