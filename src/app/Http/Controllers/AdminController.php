...
namespace DACore\BaseAdmin\Controllers;

use Illuminate\Http\Request;

use DACore\BaseAdmin\Models\Menu;
use DACore\BaseAdmin\Models\Admin;

use DACore\BaseAdmin\Libraries\Helper;
...
class AdminController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dacore.baseadmin::admin.index',['status' => $status,'menus'=>$echoMenus]);
    }

    public function home()
    {
        $adminHome = 'dacore.baseadmin::admin.home';
        if(!empty(config('dacore_baseadmin.baseadmin_homeView'))){
            $adminHome = config('dacore_baseadmin.baseadmin_homeView');
            //dd($adminHome);
        }
    ...
    public function add(Request $request){
        ...
        //读取数据库的权限信息
        //$this->setRolesArr($request);
        return view('dacore.baseadmin::admin.add',[
            'back_url'=>$back_url,
...
//            $data->group_id = $request->group_id;
        ...
        // 记录管理员操作日志
        if(config('dacore_baseadmin.baseadmin_admin_log_add')) {
            $params = [
    ...
    public function list(Request $request){
        ...
        //读取数据库的权限信息
        $this->setRolesArr($request);
        return view('dacore.baseadmin::admin.list',['data'=>$admins,'rolesJson'=>$rolesJson]);
    }
    ...
    public function change_password(Request $request){
        ...
        return view('dacore.baseadmin::admin.password.change',$compact);
    }
