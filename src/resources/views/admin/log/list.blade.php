@extends('dacore.baseadmin::layout.iframe')
...
@section('content')
    ...
    {{--顶部导航--}}
    @if(config('dacore_baseadmin.baseadmin_admin_log_nav'))
        @include(config('dacore_baseadmin.baseadmin_admin_log_nav'))
    @endif
    <!-- Panel Other -->
...
@push('startcss')
    <link href="{{config('dacore_baseadmin.baseadmin_assets_path')}}/css/plugins/bootstrap-table/bootstrap-table.min.css" rel="stylesheet">
    <link href="{{config('dacore_baseadmin.baseadmin_assets_path')}}/css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" rel="stylesheet">
@endpush

@section('myscript')
    <!-- Bootstrap table -->
    <script src="{{config('dacore_baseadmin.baseadmin_assets_path')}}/js/plugins/bootstrap-table/bootstrap-table.min.js"></script>
    <script src="{{config('dacore_baseadmin.baseadmin_assets_path')}}/js/plugins/bootstrap-table/bootstrap-table-mobile.min.js"></script>
    <script src="{{config('dacore_baseadmin.baseadmin_assets_path')}}/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"></script>
    {{--<script src="{{config('dacore_baseadmin.baseadmin_assets_path')}}/js/plugins/bootstrap-table/bootstrap-table-search.js"></script>--}}
    <script src="{{config('dacore_baseuser.baseuser_assets_path')}}/js/plugins/layer/laydate/laydate.js"></script>
    <!-- Peity -->
    <script>
