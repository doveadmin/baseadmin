...
@push('endscripts')
   <link href="{{config('dacore_baseadmin.baseadmin_assets_path')}}/css/plugins/iCheck/custom.css" rel="stylesheet">
@endpush
@push('endscripts')
    <!-- iCheck -->
    <script src="{{config('dacore_baseadmin.baseadmin_assets_path')}}/js/plugins/iCheck/icheck.min.js"></script>
    <script>
        var RolesArr = [];
