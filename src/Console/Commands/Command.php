<?php
namespace DACore\BaseAdmin\Console\Commands;
...
class Command extends BaseCommand
{
     ...
     * @var string
     */
    protected $signature = 'dacore:baseadmin';
     ...
     * @var string
     */
    protected $description = 'DACore BaseAdmin Command description';
    ...
    {
        //输出信息
        //$this->info('DACore BaseAdmin Command Screen Info.');
        $this->echoInfo('-----------------------------');
        ...
        $this->echoInfo('******* DACore BaseAdmin 【开始】 *******');
        $i = 1;
        ...
        $this->echoInfo('******* DACore BaseAdmin 【结束】 *******');
