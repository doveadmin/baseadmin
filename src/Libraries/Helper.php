<?php
namespace DACore\BaseAdmin\Libraries;

use Illuminate\Http\Request;
use DACore\BaseAdmin\Models\Admin;
use DACore\BaseAdmin\Models\AdminLog;
...
class Helper
{
    ...
    public static function getSystemRoles(){
        ...
        //如果设置了管理员首页显示分级
        if(config('dacore_baseadmin.baseadmin_roles_home_subroles')){
            $systemRoles[1]['subroles'] = config('dacore_baseadmin.baseadmin_roles_home_subroles');
        }
