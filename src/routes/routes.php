<?php
use DACore\BaseAdmin\Middleware\BaseAdminMiddleware;
use DACore\BaseAdmin\Middleware\BaseAdminMenuMiddleware;
...
Route::group([
    ...
    if(config('dacore_baseadmin.baseadmin_background_image_custom')){
