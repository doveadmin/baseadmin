...
return [
    ...
    'baseadmin_assets_path' =>'/assets/DACore/BaseAdmin',  //设置发布后样式路径
    ...
    'baseadmin_system_name' => 'DACore',  //显示公司名称，不设置默认显示DACore
    ...
    'baseadmin_login_footer' => '&copy; DACore.COM',  //是否显示登录页底部文字，'' 不显示，默认 &copy; DACore.COM,否则自定义
